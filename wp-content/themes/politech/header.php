    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <h1 class="navbar-brand" id="nav3">
                <a href="#body" style="text-transform: none"><?php echo get_setting("navbar_titulo") ?></a>
            </h1>
            <!-- /logo -->
        </div>
        ...
        <nav class="collapse navbar-collapse navbar-right" role="navigation">
            <ul id="nav" class="nav navbar-nav">
                ...
                <!--<li><div style="margin-left: 14px; margin-right: 14px; font-size: 15px; padding-top: 15px; padding-bottom: 15px; line-height: 20px; color: white; cursor: pointer" onclick="location.href='<?php echo get_site_url() ?>/processo-seletivo'">PROCESSO SELETIVO</div></li>-->
                <!--<li><a href="#servicos">Serviços</a></li>-->
                <li><a href="#galeria">Galeria</a></li>
                <!--<li><a href="#membros">Membros</a></li>-->
                <li><div style="margin-left: 15px; font-size: 15px; padding-top: 15px; padding-bottom: 15px; line-height: 20px; color: white; cursor: pointer" onclick="location.href='<?php echo get_site_url() ?>/blog'">BLOG</div></li>
